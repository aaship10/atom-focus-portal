...
export default function EmployeeDashboard() {
  return (
    <div className="bg-[#F0F0F3] text-on-surface font-body-md min-h-screen flex text-body-md">
      {/* SideNavBar (Desktop) */}
      <aside className="bg-surface text-primary font-body-md text-body-md shadow-[6px_6px_12px_#AEAEC0,-6px_-6px_12px_#FFFFFF] hidden lg:flex flex-col h-screen p-stack-md gap-stack-sm w-64 fixed left-0 top-0">
        <div className="mb-stack-lg">
          <h1 className="font-headline-md text-headline-md font-bold text-primary">FocusPortal</h1>
          <p className="text-secondary mt-1 font-body-md text-body-md">Goal Management</p>
        </div>
        <nav className="flex flex-col gap-2 flex-grow">
          <a className="text-secondary hover:text-primary hover:shadow-[6px_6px_12px_#AEAEC0,-6px_-6px_12px_#FFFFFF] rounded-xl transition-all active:shadow-[inset_2px_2px_5px_#AEAEC0] flex items-center gap-3 p-3" href="#">
            <span className="material-symbols-outlined">dashboard</span>
            <span>Dashboard</span>
          </a>
          <a className="bg-surface shadow-[inset_3px_3px_7px_#AEAEC0,inset_-2px_-2px_5px_#FFFFFF] text-primary font-bold rounded-xl active:shadow-[inset_2px_2px_5px_#AEAEC0] flex items-center gap-3 p-3" href="#">
      ...
      <nav className="lg:hidden fixed bottom-0 w-full z-50 flex justify-around items-center bg-surface px-4 py-3 shadow-[0px_-6px_12px_#AEAEC0]">
        <a className="flex flex-col items-center justify-center text-secondary-container active:scale-95 transition-transform" href="#">
          <span className="material-symbols-outlined">home</span>
          <span className="font-label-caps text-label-caps">Home</span>
        </a>
        <a className="flex flex-col items-center justify-center text-primary bg-surface-container shadow-[inset_2px_2px_5px_#AEAEC0,inset_-2px_-2px_5px_#FFFFFF] rounded-xl px-4 py-2 active:scale-95 transition-transform" href="#">
